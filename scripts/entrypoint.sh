...
exec python -m dramatiq worker --watch /app --processes 2 --threads 2 --logfile $DRAMATIQ_LOGS/dramatiq.log
...
#Обратите внимание, что при использовании этого скрипта вы должны убедиться,
# что Dramatiq установлен в контейнере и
# что ваше приложение импортирует модуль tasks, содержащий определения задач Dramatiq.
